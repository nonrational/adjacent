class Adjacent < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/nonrational/adjacent/releases/download/v0.1.0-alpha.4/adj-0.1.0-alpha.4-aarch64-apple-darwin.tar.gz"
      sha256 "3db53767939f653cf9672c7c8bfe9657dadf0b69140080a3c96a5fd7808d8d35"
    end
    on_intel do
  ...
  test do
    assert_match "0.1.0-alpha.4", shell_output("#{bin}/adj --version")
  end
end
